...
token = open("mapbox_token").read()  # Removido o ponto inicial, assumindo que o arquivo está no mesmo diretório
...
fig.update_layout(
                mapbox_accesstoken=token,  # Descomentado para usar a chave do Mapbox
